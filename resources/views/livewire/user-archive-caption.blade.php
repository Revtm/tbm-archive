<div class="post-caption p-1">
  <div class="action-button">
    <button wire:click="incrementReaction('{{ $archive->id }}')" class="rounded-md bg-red-500 hover:bg-slate-400 text-xs text-white p-1 px-3 mx-1" onclick="clickReaction('{{$archive->id}}')"><i class="fa fa-heart" aria-hidden="true"></i> MasyaAllah</button>
